...
label1=Label(w, text='STARBUCK', fg='white', bg='#272727') #decorate it
label1.configure(font=('Monotype Corsiva',34))   #You need to install this font in your PC or try another one
